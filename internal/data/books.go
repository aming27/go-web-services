...
func (b BookModel) Insert(book *Book) error {
	query := `
		INSERT INTO books (title, published, pages, rating)
		VALUES ($1, $2, $3, $4)
		RETURNING id`

	args := []interface{}{book.Title, book.Published, book.Pages, book.Rating}
...
func (b BookModel) Update(book *Book) error {
	...
	args := []interface{}{book.Title, book.Published, book.Pages, book.ID}
	return b.DB.QueryRow(query, args...).Scan(&book.CreatedAt)
}
